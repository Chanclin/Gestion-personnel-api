...
public class JwtService {
	...
	private final String ENCRYPTION_KEY = "8iQmYQUm3TlYt2AYix/zYSGlLHSuxElZXC5WErU1bRCcxhiUb0FN7si87VYYRYpR"; // Clé de chiffrement
	...
	private Map<String, String> generateJwt(Utilisateur utilisateur) {
		...
		String jwt = Jwts.builder()
			.setIssuedAt(new Date(currentTime)) // Date d'émission
		...
		// Retourner le token sous forme de Map (peut aussi retourner directement le token si besoin)
