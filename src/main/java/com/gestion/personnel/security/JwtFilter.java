...
public class JwtFilter extends OncePerRequestFilter {
	...
	public JwtFilter(final HandlerExceptionResolver handlerExceptionResolver,
			final UtilisateurService utilisateurService, final JwtService jwtService) {
	...
	protected void doFilterInternal(final HttpServletRequest request, final HttpServletResponse response,
		...
		try {
			// Bearer
			// eyJhbGciOiJIUzI1NiJ9.eyJub20iOiJBY2hpbGxlIE1CT1VHVUVORyIsImVtYWlsIjoiYWNoaWxsZS5tYm91Z3VlbmdAY2hpbGxvLnRlY2gifQ.zDuRKmkonHdUez-CLWKIk5Jdq9vFSUgxtgdU1H2216U
